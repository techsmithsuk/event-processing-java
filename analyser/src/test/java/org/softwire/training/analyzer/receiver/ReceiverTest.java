...
class ReceiverTest {
    ...
    void ignoresInvalidMessage() {
        ...
        assertThat(receiver.get().collect(Collectors.toList()), empty());
    }
    ...
    void parsesValidMessage() {
        ...
        assertThat(receiver.get().collect(Collectors.toList()), equalTo(singletonList(new Event(
    ...
    void ignoresErrorsWhenDeletingMessages() {
        ...
        assertThat(receiver.get().collect(Collectors.toList()), contains(new Event(
                UUID.fromString("4887f60d-d65c-4594-9087-aec8373b3de0"),
                UUID.fromString("d8d00d6a-8e91-44dd-926d-2b389c436d45"),
                2,
                123456789
